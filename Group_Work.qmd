...
1.1 The majority of hosts own between 1 and 2 listings, with a few managing hundreds or even thousands of properties.

1.2 The distribution highlights the presence of professional operators in London's Airbnb market, with the largest host managing over 3000 listings.
...
Next, yellow area represents medium-priced rentals, primarily offering entire homes. The government can encourage these properties to implement green measures, such as promoting energy-efficient equipment and reducing the use of one-off items.
...
In conclusion, further monitoring of the impact of short-term rentals on home prices, especially Cluster 0 and Cluster 2, could put pressure on surrounding home prices and the long-term rental market. Meanwhile, regular monitoring is needed, and countermeasures such as limiting excessive short-term rentals should be implemented..
