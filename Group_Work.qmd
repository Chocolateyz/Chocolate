...
1.1The majority of hosts own between 1 to 2 listings, with a few managing hundreds or even thousands of properties.

1.2The distribution highlights the presence of professional operators in London's Airbnb market, with the largest host managing over 3000 listings.
...
Finally, medium-priced zone (Yellow): Medium-sized properties for families in Inner London areas like Hackney and Southwark, serving as a transitional zone.
...
Next, yellow area represents medium-priced rentals, mostly offering entire homes. The government can encourage these properties to implement green measures, such as promoting energy-efficient equipment and reducing the use of one-off items.
